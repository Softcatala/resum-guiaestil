...
\cheatsheetsectiontitle{Aspectes convencionals}

\cheatsheetsubsection{Les cometes}

En anglès, majoritàriament s’utilitzen les cometes altes i les cometes simples. En canvi, en català cal utilitzar sempre les cometes baixes (\guillemotleft \guillemotright), independentment de les que apareguin al text original.
